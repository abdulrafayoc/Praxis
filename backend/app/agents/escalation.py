...
async def escalation_node(state: PraxisSessionState) -> PraxisSessionState:
    llm = ChatOpenAI(model="gpt-4o", temperature=0.1)
    prompt_text = await get_active_prompt_version("escalation") or "You are the escalation agent."
